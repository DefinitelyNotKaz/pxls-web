  ...
  const self = {
    ...
    report: function (id, x, y) {
      ...
      reportButton.addEventListener("click", function () {
        ...
        const selectedRule =
          this.closest(".modal").querySelector("select").value;
        const textarea = this.closest(".modal")
        ...
        $.post(
          ...
          function () {
            new SLIDEIN.Slidein(__("Sent report!"), "info-circle")
              .show()
              .closeAfter(3000);
            modal.closeTop(true);
          ...
          new SLIDEIN.Slidein(__("Error sending report."), "info-circle")
            .show()
            .closeAfter(3000);
        });
      });
        ...
        modal.buildDom(
          ...
          crel(
            ...
            crel(
              ...
              crel(
                "option",
                __("Rule #1: Hateful/derogatory speech or symbols"),
              ),
              crel(
                "option",
                __("Rule #2: Nudity, genitalia, or non-PG-13 content"),
              ),
            ...
            crel(
              ...
              crel(
                "button",
                { class: "text-button", onclick: () => modal.closeAll() },
                __("Cancel"),
              ),
              reportButton,
            ),
    ...
    create: function (data) {
      ...
      self
        ...
        .append(() => {
          ...
          return $("<p>").text(
            __("This pixel is background (was not placed by a user)."),
          );
        })
        .append(() => {
          const hooks = data.bg
        ...
        .append(() => {
          ...
          const span = $('<span class="label-text">').text(
            __("Hide sensitive information"),
          );
    ...
    webinit: function () {
      ...
      board.getRenderBoard().on("click", function (evt) {
        ...
        if (evt.ctrlKey) {
          ...
          historical(board, evt.clientX, evt.clientY);
        }
      });
    },
